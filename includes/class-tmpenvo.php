...
class Ggowl {
	...
	public function __construct() {
		if ( defined( 'TMPENVO_VERSION' ) ) {
			$this->version = TMPENVO_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'tmpenvo';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-tmpenvo-loader.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-tmpenvo-admin.php';
