...
class Ggowl_Elementor_product_featuredimage extends Widget_Base
{
    ...
    {
        return esc_html__('Product Featured Image', 'tmpenvo');
    }

    public function get_name()
    {
        return 'tmpenvo_product_featuredimage';
    }
    ...
    {
        return ['image', 'photo', 'visual', 'dyn', 'owl', 'featured', 'product', 'woo'];
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            'section_image',
            [
                'label' => esc_html__('Product Featured Image', 'tmpenvo'),
            ]
        );
    ...
    protected function render()
    {
        ...
        if ($post->post_type == 'tmpenvo_template'):
            $post_id         = get_the_ID();
            $tmpenvo_post_type = $tmpenvo_product_featuredimage_instance->tmpenvo_active_post_template($post_id);
            $tmpenvo_id        = $tmpenvo_product_featuredimage_instance->tmpenvo_single_post_returner($tmpenvo_post_type);
            if (is_int($tmpenvo_id)) {
                $attachment_id = $tmpenvo_product_featuredimage_instance->tmpenvo_product_featuredimage_gen($tmpenvo_id);
