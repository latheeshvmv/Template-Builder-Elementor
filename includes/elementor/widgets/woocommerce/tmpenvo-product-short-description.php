...
class TMPENVO_Elementor_product_short_description extends \Elementor\Widget_Base
{
    ...
    protected function render()
    {
        ...
        $tmpenvo_product_short_description_instance = new \TMPENVOHELPERNS\TMPENVOHelper();
