...
class TMPENVO_Elementor_Featured_image_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'tmpenvo_core_featuredimage';
    }

    public function get_title()
    {
        return esc_html__('Featured Image', 'tmpenvo');
    }
    ...
    {
        return ['image', 'photo', 'visual', 'owl', 'acf'];
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'image',
            [
                'label'   => esc_html__('Choose Placeholder Image', 'tmpenvo'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tmpenvo-widget-core_featuredimage-inner' => 'text-align: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $tmpenvo_core_featuredimage_instance = new \TMPENVOHELPERNS\TMPENVOHelper();
        global $post;
        echo '<div class="tmpenvo-widget-core_featuredimage" >';
        echo '<div class="tmpenvo-widget-core_featuredimage-inner elementor-image" >';

        if ($post->post_type == 'tmpenvo_template'):
            $post_id         = get_the_ID();
            $tmpenvo_post_type = $tmpenvo_core_featuredimage_instance->tmpenvo_active_post_template($post_id);
            $tmpenvo_id        = $tmpenvo_core_featuredimage_instance->tmpenvo_single_post_returner($tmpenvo_post_type);
            if (is_int($tmpenvo_id)) {
                $attachment_id = $tmpenvo_core_featuredimage_instance->tmpenvo_post_featuredimage_gen($tmpenvo_id);
                $this->add_render_attribute('wrapper', 'class', 'elementor-image');
                if (!empty($settings['shape'])) {
                    $this->add_render_attribute('wrapper', 'class', 'elementor-image-shape-' . $settings['shape']);
                }
                $featuredimage_lightbox = get_the_post_thumbnail_url($tmpenvo_id, 'full');
                ...
                ?>
			 					...
			 					<?php if ($link): ?>
			 					<a <?php echo wp_kses($this->get_render_attribute_string('link'), $tmpenvo_core_featuredimage_instance->ggwol_allowed_html()); ?>>
			 					<?php endif;
            if (empty(TMPENVO_Featurred_Image_Getter::get_attachment_image_html_generator($attachment_id, $settings))) {
