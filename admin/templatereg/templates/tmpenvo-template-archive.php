...
get_header(); ?>
	    <div class="tmpenvo-container tmpenvo-container-<?php echo get_the_ID(); ?>" id="tmpenvo-container tmpenvo-container-<?php echo get_the_ID(); ?>">
	            <?php
							$tmpenvoacf_admin_options = get_option('tmpenvo_admin_options_archive'); // Array of All Options
							$tmpenvo_admin_template_options = $tmpenvoacf_admin_options['tmpenvo_select_post_template_repeater_archive'];
